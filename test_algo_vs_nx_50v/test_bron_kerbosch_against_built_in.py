...
from functions.clique_algorithms import Bron_Kerbosch
from functions.read_DIMACS import read_dimacs_clq

# 37 Tests and 222 Asserts
class TestBronKerboschAgainstBuiltIn(unittest.TestCase):
    """
    Compares outputs of Bron_Kerbosch(nx.Graph) to networkX built-in function find_cliques(nx.Graph)
