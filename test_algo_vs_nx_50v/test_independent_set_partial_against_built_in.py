...
class TestIndependentSetAgainstBuiltIn(unittest.TestCase):
    """
    Compares outputs of custom_with_greedy(nx.Graph, mode) to networkX built-in function find_cliques(nx.Graph)
    ---A VARIANT OF BRON KERBOSCH PRUNING USING INDEPENDENT SET GREEDY COLOURING HEURISTIC---
    ...
    def test_brock200_2(self):
        ...
        max_c = custom_with_partial_greedy(G, "independent_set")
