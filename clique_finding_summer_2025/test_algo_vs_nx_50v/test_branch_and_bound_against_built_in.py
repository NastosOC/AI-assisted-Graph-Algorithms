...
from functions.clique_algorithms import branch_and_bound
from functions.read_DIMACS import read_dimacs_clq

# 37 Tests and 222 Asserts
class TestBranchBoundAgainstBuiltIn(unittest.TestCase):
    """
    Compares outputs of branch_and_bound(nx.Graph) to networkX built-in function find_cliques(nx.Graph)
    ...
    def test_brock200_2(self):
        ...
        H = G.subgraph(range(50))

        max_i = max(find_cliques(H), key=len)
        max_c = branch_and_bound(H)
