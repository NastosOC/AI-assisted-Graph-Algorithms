...
class TestBronKerboschPivoting(unittest.TestCase):
    """
    Testing Bron_Kerbosch_Pivoting(nx.Graph) algorithm on various edge cases.
    ---THIS ALGORITHM HAS BEEN DETERMINED UNFAVORABLE---
...
# 1. Basic Structures
    def test_empty_graph(self):
        ...
        G = nx.Graph()
        max_clq = Bron_Kerbosch_Pivoting(G)
