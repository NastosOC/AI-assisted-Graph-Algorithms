...
class TestGreedyRandomSequential(unittest.TestCase):
    """
    Testing custom_with_greedy(nx.Graph, mode) algorithm on various edge cases.
...
# 1. Basic Structures
    def test_empty_graph(self):
        ...
        G = nx.Graph()
        max_clq = custom_with_greedy(G, "random_sequential")
