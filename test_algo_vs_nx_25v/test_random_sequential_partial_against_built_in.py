...
class TestRandomSequentialAgainstBuiltIn(unittest.TestCase):
    ...
    Each test compares output using a 25-node subgraph of all DIMACS graphs.
    Asserts for each case run through:
        ...
        A sanity test confirming the clique size does not exceed 25
    ...
    def test_brock200_2(self):
        ...
        self.assertLessEqual(len(max_c), 25) # Clique size <= 25 (size of H)
